            ...
            <div className="flex justify-center">
                ...
                <div className='flex flex-row items-center justify-center mb-1'>
                    <form onSubmit={(event) => {
                        ...
                        <input className='w-56 mb-1 mr-1 ml-2 mt-1' type="text" name="allowAddress" placeholder='Wallet Address' value={allowAddress} onChange={handleAllowAddressChange} />
                        <button className='w-48 mb-1 mt-1 mr-2 ml-1'> Give Permission </button>
                    </form>
                </div>
                <form onSubmit={(event) => {
                    event.preventDefault();
