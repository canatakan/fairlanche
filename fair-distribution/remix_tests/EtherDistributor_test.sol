...
contract testSuite {
    ...
    function checkDemands() public {
        ...
        Assert.equal(
            etherDistributor.totalDemand(),
            13,
            "Invalid demand count"
        );
    }

    function checkCalculateShare() public {
        (uint16 share, uint256 distribution) = etherDistributor
            .calculateShare();
